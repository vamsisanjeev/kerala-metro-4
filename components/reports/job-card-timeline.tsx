...
import { ClipboardList, Calendar, CircleAlert as AlertCircle } from 'lucide-react';
                    ...
                    {jobCards.map((jobCard, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell>
                            <div className="flex items-center gap-2">
                              <span className="text-xl">{getTaskTypeIcon(jobCard.taskType)}</span>
                              <span className="text-white font-medium">{jobCard.taskType}</span>
                            </div>
                          </TableCell>
                          <TableCell>
                            <Badge className={`${getPriorityColor(jobCard.priority)} border`}>
                              {jobCard.priority}
                            </Badge>
                          </TableCell>
                          <TableCell>
                          ...
                          <TableCell>
                            ...
                            >
                              <Badge className={`${getStatusColor(jobCard.status)} border shadow-lg`}>
                                {jobCard.status}
                              </Badge>
                            </motion.div>
                          </TableCell>

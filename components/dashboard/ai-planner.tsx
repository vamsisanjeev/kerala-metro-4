...
import { Sparkles, CirclePlay as PlayCircle, Brain } from 'lucide-react';
                  ...
                  <AnimatePresence>
                    {allocations.map((allocation, index) => (
                      ...
                      >
                        ...
                        <TableCell>
                          <Badge className={`${getStatusColor(allocation.currentStatus)} border`}>
                        ...
                        <TableCell>
                          ...
                          >
                            <Badge className={`${getStatusColor(allocation.suggestedStatus)} border shadow-lg`}>

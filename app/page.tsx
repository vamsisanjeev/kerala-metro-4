...
import { User, Lock, Eye, EyeOff, Loader as Loader2, CircleAlert as AlertCircle, CircleCheck as CheckCircle } from 'lucide-react'
          ...
          >
            ...
            <div className="space-y-5">
              ...
              >
                <a
                  href="#"
                  className="text-sm text-white/70 transition-all hover:text-white hover:underline hover:underline-offset-4"
                >
                  Forgot Password?
                </a>
              </motion.div>
